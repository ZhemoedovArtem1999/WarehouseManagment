...
const SnipmentDocument = () => {
  ...
  const [dataFilter, setDataFilter] = useState<SnipmentFilterData>();
  const [filter, setFilter] = useState<SnipmentFilter>({
    PeriodS: null,
    PeriodPo: null,
    Numbers: [],
    Resources: [],
  ...
  const [data, setData] = useState<SnipmentDocumentViewDto[]>();
  ...
  const handleAdd = () => {
    navigate("/snipmentDocument/add");
  };

  const handleEdit = (id: number) => {
    navigate(`/snipmentDocument/edit/${id}`);
  };
  ...
  return (
    <>
      ...
      <p className="content-header">Отгрузки</p>
      <div className="filter">
        <div className="filter-field">
          ...
          >
            <Calendar
              id={nameof<SnipmentFilter>((_) => _.PeriodS)}
            ...
            />
            <Calendar
              id={nameof<SnipmentFilter>((_) => _.PeriodPo)}
              className="calendar-no-button-bg p-calendar-filter"
        ...
        <div className="filter-field">
          <label htmlFor={nameof<SnipmentFilter>((_) => _.Numbers)}>
            Номер поступления
          </label>
          <MultiSelect
            id={nameof<SnipmentFilter>((_) => _.Numbers)}
        ...
        <div className="filter-field">
          <label htmlFor={nameof<SnipmentFilter>((_) => _.Clients)}>
            Клиент
          </label>
          <MultiSelect
            id={nameof<SnipmentFilter>((_) => _.Clients)}
            value={filter.Clients}
            onChange={(e) => {
              setFilter((prev) => ({
                ...prev,
                Clients: e.value as number[],
              }));
            }}
        ...
        <div className="filter-field">
          <label htmlFor={nameof<SnipmentFilter>((_) => _.Resources)}>
            Ресурс
          </label>
          <MultiSelect
            id={nameof<SnipmentFilter>((_) => _.Resources)}
        ...
        <div className="filter-field">
          <label htmlFor={nameof<SnipmentFilter>((_) => _.Units)}>
            Единица измерения
          </label>
          <MultiSelect
            id={nameof<SnipmentFilter>((_) => _.Units)}
            value={filter.Units}
            onChange={(e) => {
              setFilter((prev) => ({
                ...prev,
              ...
              >
                ...
                >
                  ...
                  style={{transform: 'scale(1.2)' }}
                    className={`badge ${item.sign ? "bg-success" : "bg-secondary"}`}
                  >
                    {item.sign ? "Подписан" : "Не подписан"}
                  </span>
                </td>
                {!item.documentResources?.length && (
                  <>
...
export default SnipmentDocument;
